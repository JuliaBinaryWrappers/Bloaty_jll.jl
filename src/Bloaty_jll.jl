...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Bloaty_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("179dd4c9-9988-5cd9-88b2-3b95f65d2a72"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Bloaty", artifacts_toml) for e in artifacts["Bloaty"]]
...
if best_platform === nothing
    @debug("Unable to load Bloaty; unsupported platform $(triplet(platform_key_abi()))")
else
